...
class auth{
    ...
    public function signup($conn, $ObjGlob, $ObjSendMail, $lang){
        if(isset($_POST["signup"])){
            ...
            $fullname = $_SESSION["username"] = $conn->escape_values(ucwords(strtolower($_POST["username"])));
            $email_address = $_SESSION["email"] = $conn->escape_values(strtolower($_POST["email"]));
            $username = $_SESSION["password"] = $conn->escape_values(strtolower($_POST["password"]));
